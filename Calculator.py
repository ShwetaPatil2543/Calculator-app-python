...
class Calculator:
    ...
    def solve(self):
        try:
            ...
            self.entry_value = str(result)  # Convert result to string
            self.equation.set(self.entry_value)  # Set string result to equation
            self.entry_value = ''  # Clear entry_value for the next calculation
